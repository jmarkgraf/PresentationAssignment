...
![](SavingsBank_map.png) # any ideas how to centre?
...
Subset
  ...
  + only elections from 2006 to 2014
  + only elections with at least two candidates
  + excluded elections where a run-off was necessary
